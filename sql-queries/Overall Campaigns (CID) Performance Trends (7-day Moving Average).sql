...
select
  ...
  1.0 * sum(sum(clicks + views)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
  ...
  1.0 * sum(sum(click_conversions + view_conversions)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
  ...
  1.0 * sum(sum(click_conversions + view_conversions)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
    / sum(NULLIF(sum(clicks + views), 0)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW) as "ConversionRate",
  ...
  1.0 * sum(sum(media_spend + data_spend + platform_spend + legacy_spend)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
    / sum(NULLIF(sum(click_conversions + view_conversions), 0)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW) as "CPA",
  ...
  1.0 * sum(sum(click_order_value + view_order_value)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
  ...
  1.0 * sum(sum(click_order_value + view_order_value) - sum(media_spend + data_spend + platform_spend + legacy_spend)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
  ...
  1.0 * sum(sum(media_spend + data_spend + platform_spend + legacy_spend)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
    / sum(NULLIF(sum(clicks + views), 0)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW) as "CostPerVisit",
  ...
  1.0 * sum(sum(views)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
  ...
  1.0 * sum(sum(view_conversions)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
  ...
  1.0 * sum(sum(media_spend + data_spend + platform_spend + legacy_spend)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW)
    / sum(NULLIF(sum(views), 0)) over (ORDER BY day ROWS BETWEEN 6 PRECEDING AND CURRENT ROW) as "CostPerView"
from

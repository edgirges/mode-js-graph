...
(function() {
    ...
    const CHART_CONFIG = {
        ...
        fallbackDatasetIndex: 6, // Fallback to datasets[6] if specific dataset not found
    ...
    function attemptInitialization() {
        ...
        const togglesContainer = document.querySelector('.pmp-v-open-market-area-toggles');
    ...
    function loadModeData() {
        console.log('=== PMP vs Open Market: Loading data from Mode Analytics ===');
    ...
    function processData() {
        console.log('=== Processing PMP vs Open Market data ===');
    ...
    function initializeChart() {
        console.log('=== Initializing PMP vs Open Market chart ===');
        ...
        const canvas = document.getElementById('pmpVOpenMarketAreaChart');
        if (!canvas) {
            console.error('Canvas not found! Looking for ID: pmpVOpenMarketAreaChart');
            return;
        }
    ...
    function createMetricToggles() {
        const togglesContainer = document.querySelector('.pmp-v-open-market-area-toggles');
        if (!togglesContainer) {
            console.error('Toggles container not found! Looking for: .pmp-v-open-market-area-toggles');
            return;
        }
    ...
    function switchTimeRange(timeRange) {
        ...
        const controlButtons = document.querySelectorAll('.pmp-v-open-market-area-controls .control-btn');
    ...
    console.log('=== PMP vs Open Market Area Chart initialized successfully! ===');
    console.log('Available functions:', Object.keys(window.PmpVOpenMarketAreaChart));
    console.log('Debug commands:');
    console.log('- PmpVOpenMarketAreaChart.debug.showDatasets()');
    console.log('- PmpVOpenMarketAreaChart.debug.showMetrics()');
    console.log('- PmpVOpenMarketAreaChart.debug.forceLoad()');
